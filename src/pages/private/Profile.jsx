...
import { Settings, Trophy, Calendar, Award, Star, ExternalLink, Mail, User } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between space-y-4 md:space-y-0">
              <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
                <Avatar className="w-24 h-24 md:w-32 md:h-32">
                  ...
                  <AvatarFallback className="text-2xl md:text-4xl">{user.name.charAt(0)}</AvatarFallback>
                </Avatar>
              ...
              <Button onClick={handleEditProfile} className="self-center md:self-start">
        ...
        <div className="grid gap-6 md:grid-cols-2">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-blue-50 rounded-lg">
                  ...
                  <div className="text-sm text-muted-foreground">Workshops Enrolled</div>
                </div>
                <div className="text-center p-3 bg-green-50 rounded-lg">
                  <div className="text-2xl font-bold text-green-600">{stats.certificatesEarned}</div>
                  <div className="text-sm text-muted-foreground">Certificates Earned</div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-purple-50 rounded-lg">
                  <div className="text-2xl font-bold text-purple-600">{stats.completedAssignments}</div>
                  <div className="text-sm text-muted-foreground">Assignments Submitted</div>
                </div>
                <div className="text-center p-3 bg-yellow-50 rounded-lg">
                  <div className="text-2xl font-bold text-yellow-600">{stats.reviewsGiven}</div>
                  <div className="text-sm text-muted-foreground">Reviews Given</div>
                </div>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                <div className="text-lg font-bold text-gray-600">★ {stats.averageRating}/5.0</div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Based on workshops you've enrolled in</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your latest achievements and submissions</CardDescription>
          </CardHeader>
          <CardContent>
